...
@Service
public class StringAsTextAreaBpUiFactory extends AbstractBpUiFactory<Object, String> {

    public StringAsTextAreaBpUiFactory() {
    ...
    public <CB, CP> boolean canHandle(@Nonnull Class<CB> beanClass, @Nonnull BeanProperty<CB, CP> beanProperty) {
        ...
        StringAsTextAreaBpUi annotation = beanProperty.findAnnotation(StringAsTextAreaBpUi.class);
        if (annotation == null) {
            return false;
        }
    ...
    @Override
    public @Nonnull <B, P extends String> BpUiWidget<B> createWidget(@Nonnull BpUiWidgets<B> bpUiWidgets, @Nonnull BeanProperty<B, P> beanProperty) {
        return new SimpleBpUiWidget<>(bpUiWidgets, beanProperty, getI18nSupport(), labelText -> {
            TextArea field = new TextArea(labelText);
            StringAsTextAreaBpUi annotation = beanProperty.findAnnotation(StringAsTextAreaBpUi.class);
