...
@SpringComponent
@UIScope
public class ScheduleGrid extends GenericCrudGrid<Long, SchedulePO, ScheduleRepository> {

    public ScheduleGrid(ScheduleRepository repository, ScheduleForm beanForm) {
        super(SchedulePO.class, repository, beanForm);
    }
