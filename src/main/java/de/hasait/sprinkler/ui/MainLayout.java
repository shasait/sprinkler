...
import de.hasait.sprinkler.security.SecurityService;
...
public class MainLayout extends AppLayout {
    ...
    private void createDrawer() {
        addToDrawer(new VerticalLayout( //
                new RouterLink(SchedulesView.TITLE, SchedulesView.class), //
                new RouterLink(ScheduleLogsView.TITLE, ScheduleLogsView.class), //
                new RouterLink(RelaysView.TITLE, RelaysView.class), //
                new RouterLink(RelayProvidersView.TITLE, RelayProvidersView.class),//
                new RouterLink(SensorsView.TITLE, SensorsView.class), //
                new RouterLink(SensorValuesView.TITLE, SensorValuesView.class), //
                new RouterLink(SensorProvidersView.TITLE, SensorProvidersView.class) //
        ));
    }
