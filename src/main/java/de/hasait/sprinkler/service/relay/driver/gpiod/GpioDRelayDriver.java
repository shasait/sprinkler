...
package de.hasait.sprinkler.service.relay.driver.gpiod;
 ...
 */
@Service
public class GpioDRelayDriver extends AbstractPinBasedRelayDriver<String> {

    public static final String PROVIDER_ID = "gpiod";

    private static final Logger LOG = LoggerFactory.getLogger(GpioDRelayDriver.class);
    ...
    public @Nonnull String parseDriverConfigText(@Nullable String driverConfigText) {
        ...
        if (driverConfigText.contains("\n")) {
            throw new IllegalArgumentException("Cannot contain newlines");
        }
