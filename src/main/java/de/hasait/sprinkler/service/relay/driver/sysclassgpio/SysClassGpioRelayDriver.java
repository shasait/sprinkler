...
package de.hasait.sprinkler.service.relay.driver.sysclassgpio;
 ...
 */
@Service
public class SysClassGpioRelayDriver extends AbstractPinBasedRelayDriver<String> {

    public static final String PROVIDER_ID = "sysclass-gpio";

    private static final Logger LOG = LoggerFactory.getLogger(SysClassGpioRelayDriver.class);
    ...
    public SysClassGpioRelayDriver() {
    ...
    public @Nonnull String parseDriverConfigText(@Nullable String driverConfigText) {
        ...
        Integer.parseInt(driverConfigText);
