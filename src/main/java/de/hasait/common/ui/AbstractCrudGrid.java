 ...
 *
 */
public abstract class AbstractCrudGrid<PO extends PersistantObject, R extends SearchableRepository<PO, Long>, BF extends AbstractCrudForm<PO, R>> extends AbstractGridView<PO> {
